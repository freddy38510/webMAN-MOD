...
do
	...
	then
		...
		[ -f webMAN_MOD_1.47.xx_Updater.pkg ] && rm webMAN_MOD_1.47.xx_Updater.pkg || :
		finished=true;
	elif [ $choice -eq 2 ]
	then
		yes |"cp" -rf themes/kmz_theme/* pkgfiles/USRDIR;
		echo -ne "\033]0;Building pkg with kzm theme\007";
		[ -f webMAN_MOD_1.47.xx_Updater_kmz_theme.pkg ] && rm webMAN_MOD_1.47.xx_Updater_kmz_theme.pkg || :
		finished=true
	elif [ $choice -eq 3 ]
	then
		yes |"cp" -rf themes/metalification_theme/* pkgfiles/USRDIR;
		echo -ne "\033]0;Building pkg with metalification theme\007";
		[ -f webMAN_MOD_1.47.xx_Updater_metalification_theme.pkg ] && rm webMAN_MOD_1.47.xx_Updater_metalification_theme.pkg || :
		finished=true
	elif [ $choice -eq 4 ]
	then
		yes |"cp" -rf themes/rebugification_theme/* pkgfiles/USRDIR;
		echo -ne "\033]0;Building pkg with rebugification theme\007";
		[ -f webMAN_MOD_1.47.xx_Updater_rebugification_theme.pkg ] && rm webMAN_MOD_1.47.xx_Updater_rebugification_theme.pkg || :
		finished=true
	else
		echo "Invalid number";
	fi
...
[ $choice = "1" ] && mv EP0001-UPDWEBMOD_00-0000000000000000.pkg webMAN_MOD_1.47.xx_Updater.pkg && echo "webMAN_MOD_1.47.xx_Updater.pkg built" || :
[ $choice = "2" ] && mv EP0001-UPDWEBMOD_00-0000000000000000.pkg webMAN_MOD_1.47.xx_Updater_kmz_theme.pkg && echo "webMAN_MOD_1.47.xx_Updater_kmz_theme.pkg built" && rm pkgfiles/USRDIR/icon_wm_root.png || :
[ $choice = "3" ] && mv EP0001-UPDWEBMOD_00-0000000000000000.pkg webMAN_MOD_1.47.xx_Updater_metalification_theme.pkg && echo "webMAN_MOD_1.47.xx_Updater_metalification_theme.pkg built" && rm pkgfiles/USRDIR/icon_wm_bdv.png && rm pkgfiles/USRDIR/icon_wm_ps3xtr.png && rm pkgfiles/USRDIR/icon_wm_sacd.png && rm pkgfiles/USRDIR/icon_wm_root.png || :
[ $choice = "4" ] && mv EP0001-UPDWEBMOD_00-0000000000000000.pkg webMAN_MOD_1.47.xx_Updater_rebugification_theme.pkg && echo "webMAN_MOD_1.47.xx_Updater_rebugification_theme.pkg built" && rm pkgfiles/USRDIR/icon_wm_bdv.png && rm pkgfiles/USRDIR/icon_wm_ps3xtr.png && rm pkgfiles/USRDIR/icon_wm_sacd.png && rm pkgfiles/USRDIR/icon_wm_root.png || :
